-- Use FzfLua over Telescope for fuzzy finding and picking.
--
...
--
-- See: https://github.com/nickcernis/neovim-config/blob/main/lua/config/plugins/fzf.lua
return {
  {
    "ibhagwan/fzf-lua",
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>fb", fzf_lua.buffers, { desc = "buffers", silent = true, noremap = true })
      vim.keymap.set(
        "n",
        "<leader>fy",
      ...
      vim.keymap.set("n", "<leader>ff", fzf_lua.files, { desc = "files", silent = true, noremap = true })
      vim.keymap.set("n", "<leader>fg", fzf_lua.live_grep, { desc = "grep", silent = true, noremap = true })
      vim.keymap.set("n", "<leader>fl", fzf_lua.blines, { desc = "find", silent = true, noremap = true })
    end,
  },
}
